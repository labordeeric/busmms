...
<head>
  ...
  <title>Garage Alpha | Garage List</title>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Garage List &emsp; &emsp;&emsp;&emsp;&emsp;
              <?php
            ...
            <div class="card-tools">
              ...
              <a href="garage-add.php" type="button" class="btn btn-success" title="New">
                ADD
              </a>
          ...
          <div class="card-body p-0">
            <table class="table table-striped projects">
              ...
              <?php
              $I = 0;
              $sql = "SELECT id, name FROM garage";
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="garage-edit.php?id=<?php echo $row['id']; ?>">
