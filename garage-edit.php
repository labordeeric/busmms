...
<head>
  ...
  <title>Garage Alpha | Garage Edit</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="make.php">GARAGE</a></li>
                <li class="breadcrumb-item active">Garage Edit</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <form action="Utilities/garage-edit-func.php?id=<?php echo $id; ?>" method="POST" id="frm1">
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  $sql = "SELECT id,name FROM garage WHERE id = $id";
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" class="form-control" name="name" value="<?php echo $rowEntity['name']; ?>" required>
                  </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="button" value="Update Garage" class="btn btn-success float-right" id="btnUpdate">
          </div>
        </div>
      </section>
      <!-- /.content -->
