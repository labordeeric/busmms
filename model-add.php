...
<head>
  ...
  <title>Garage Alpha | Model Add</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="role.php">MODELS</a></li>
                <li class="breadcrumb-item active">Model Add</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        <form action="Utilities/model-add-func.php" method="POST" id="frm1">
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select id="makeid" class="form-control" name="makeid">
                      <?php
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="button" value="Create new Model" class="btn btn-success float-right" id="btnCreate">
          </div>
        </div>
      </section>
      <!-- /.content -->
