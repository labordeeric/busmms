...
<head>
  ...
  <title>Garage Alpha | Make List</title>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Make List &emsp; &emsp;&emsp;&emsp;&emsp;
              <?php
            ...
            <div class="card-tools">
              ...
              <a href="make-add.php" type="button" class="btn btn-success" title="New">
                ADD
              </a>
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                  <tr>
                    ...
                    <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="make-edit.php?id=<?php echo $row['id']; ?>">
